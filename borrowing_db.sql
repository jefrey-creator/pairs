...
--
-- Host: localhost
-- Generation Time: Oct 24, 2024 at 05:10 PM
...
(3, 'admin', '$2y$10$QUpQKOFMIvGliLl7Q6XrceMevdsKTqmtpBemYClhxA9obkohjbc0u', 2, 0, NULL, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Jmzbfpk8zb4dcHZKaqqkHBDrm9KaxZHQm0DiF8uMxCQ', NULL, '8c31980ab8641a4d5d0e5f9b347a1dd4'),
...
INSERT INTO `tbl_borrow` (`borrow_id`, `borrower_id`, `date_borrowed`, `date_returned`, `item_id`, `borrowed_qty`, `approved_qty`, `remarks`, `status`, `order_num`, `purpose`) VALUES
(16, 7, '2024-10-22 21:49:07', '2024-10-30', 'NjcwZmMyNWI4ZTkxYzE3MjkwODYwNDM=', '12', 8, NULL, 3, '1729604947', 'test borrowed'),
(17, 7, '2024-10-22 21:49:07', '2024-11-07', 'NjcwZmMzNTk4NmU2NDE3MjkwODYyOTc=', '1', 1, NULL, 3, '1729604947', 'rrr'),
(18, 7, '2024-10-22 22:15:24', '2024-10-22', 'NjcwZmMyNWI4ZTkxYzE3MjkwODYwNDM=', '1', 3, NULL, 3, '1729604947', 'test');
...
(8, 'item_delivered', '<p></p><h2 class=\"\" style=\"text-align: center; \"><span style=\"text-align: var(--bs-body-text-align);\">WELCOME TO PAPERLESS ASSESSMENT INVENTORY MANAGEMENT SYSTEM</span><span style=\"text-align: var(--bs-body-text-align);\">S</span></h2><p style=\"text-align: left;\" class=\"\"><span style=\"text-align: var(--bs-body-text-align);\"><br></span></p><p style=\"text-align: left;\" class=\"\">Dear [name],</p><p style=\"text-align: left;\" class=\"\">Your item request has been successfully delivered.&nbsp;</p><p style=\"text-align: left;\" class=\"\">Here are the list of delivered items:</p>\n\n\n<table style=\"\\&quot;border-collapse:\" collapse\\\"=\"\"><thead><tr><th>Item</th><th>Quantity</th><th>Purpose</th><th><p>Expected Date of Return</p></th></tr></thead><tbody><tr></tr></tbody></table>\n\n\n<p></p><p>Request Number:&nbsp;<span style=\"font-weight: bolder;\">[order_num]</span></p><p><span style=\"font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight); text-align: var(--bs-body-text-align);\"><br></span></p><p><span style=\"font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight); text-align: var(--bs-body-text-align);\">Best regards,</span></p><p><span style=\"font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight); text-align: var(--bs-body-text-align);\">- PAIRS Management</span></p>', 'Item Delivered');
...
(5, 12, 'NjcwZmMyNWI4ZTkxYzE3MjkwODYwNDM=', 1),
...
--
ALTER TABLE `tbl_email_config`
  MODIFY `config_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

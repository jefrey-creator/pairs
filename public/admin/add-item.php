                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <button class="btn btn-primary mt-3 float-end" type="submit" id="saveItem">Save Item</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            $('#saveItem').on('click', function(e){
                ...
                if(i_desc == ""){
                    ...
                    Swal.fire({
                        ...
                        icon: "error"
                    }).then( () => $('#saveItem').html(`Save item`).removeAttr('disabled', 'disabled') );
                    return false;
                }

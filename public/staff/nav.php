<nav class="navbar navbar-expand-lg sticky-top bg-primary fs-5">
        ...
        <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-light" href="#">
                    ...
                    Barrow <span class="badge text-bg-danger">4</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn btn-light" href="#">
                    <i class="bi bi-bookmark-check"></i>
                    Reservation <span class="badge text-bg-danger">4</span>
                </a>
            </li>
        </ul>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-5">
                        <li class="nav-item">
                            <a class="nav-link active_link" aria-current="page" href="#">
